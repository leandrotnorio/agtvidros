      ...
      <div className="p-5 flex items-center justify-between text-left">
        ...
        {(() => {
          switch (projeto.categoria) {
            ...
            case "Portas":
              return <DoorClosed className="w-6 h-6 text-blue-600" />;
            case "Sacadas":
              return <PanelsTopLeft className="w-6 h-6 text-blue-600" />;
            case "Box de Banheiro":
              return <ShowerHead className="w-6 h-6 text-blue-600" />;
            default:
